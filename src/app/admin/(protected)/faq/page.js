...
import { getFaqItems, deleteFaqItem } from "./actions";
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="font-heading text-3xl text-dark mb-1">FAQ</h1>
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          {Object.entries(grouped).map(([category, categoryItems]) => (
            <div key={category}>
              <h2 className="font-heading text-lg text-dark mb-3">
                {category}
              </h2>
                ...
                {categoryItems.map((item) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-charcoal text-xs line-clamp-2">
                        {item.answer}
                      </p>
                    </div>
